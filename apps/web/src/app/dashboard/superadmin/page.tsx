    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-3xl backdrop-blur-xl border-l-4 border-l-amber-500">
          ...
          <h2 className="text-3xl font-black tracking-tight text-white mt-2">14 250 000 <span className="text-lg font-bold text-amber-400">FCFA</span></h2>
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-3xl backdrop-blur-xl border-l-4 border-l-emerald-500">
          ...
          <h2 className="text-3xl font-black tracking-tight text-white mt-2">2 480 000 <span className="text-lg font-bold text-emerald-400">FCFA</span></h2>
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-3xl backdrop-blur-xl border-l-4 border-l-blue-500">
          ...
          <h2 className="text-3xl font-black tracking-tight text-white mt-2">840 000 <span className="text-lg font-bold text-blue-400">FCFA</span></h2>
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-3xl backdrop-blur-xl border-l-4 border-l-purple-500">
          ...
          <h2 className="text-3xl font-black tracking-tight text-white mt-2">285 000 <span className="text-lg font-bold text-purple-400">FCFA</span></h2>
