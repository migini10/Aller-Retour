...
export default function ColisPage() {
  ...
  return (
    <div className="flex-1 w-full overflow-y-auto overscroll-contain scrollbar-hide flex flex-col items-center bg-slate-50 dark:bg-black transition-colors duration-300">
