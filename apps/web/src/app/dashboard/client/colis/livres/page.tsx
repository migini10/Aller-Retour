      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-24">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white flex items-center gap-3">
              <CheckCircle2 className="w-7 h-7 text-emerald-500" /> Colis Livrés
            </h1>
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Historique de vos colis arrivés à destination.</p>
          </div>
        </div>
        ...
        <div className="mb-8 relative max-w-md">
          ...
          <input 
            ...
            className="w-full bg-white dark:bg-[#141414] border border-slate-200 dark:border-[#2A2A2A] rounded-xl pl-12 pr-4 py-3.5 text-slate-900 dark:text-white placeholder:text-slate-400 text-sm outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all shadow-sm"
          />
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white dark:bg-[#141414] rounded-2xl p-10 text-center border border-slate-200 dark:border-[#2A2A2A]">
            ...
            <p className="text-slate-500 font-medium">Aucun colis livré trouvé.</p>
          </div>
        ) : (
          <div className="grid gap-4">
            {filteredColis.map((c, i) => (
              <div key={i} className="bg-white dark:bg-[#141414] border border-slate-200 dark:border-[#2A2A2A] rounded-2xl p-5 flex flex-col sm:flex-row justify-between sm:items-center gap-4 hover:border-emerald-500/30 transition-colors shadow-sm">
                <div>
