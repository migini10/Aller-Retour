        ...
        {step === 2 && (
          <div className="max-w-4xl mx-auto animate-in slide-in-from-right-8 duration-300">
            <div className="flex flex-col lg:flex-row gap-8">
              <div className="flex-1 bg-slate-900 border border-slate-700 rounded-3xl p-6 flex flex-col items-center">
                <div className="w-full max-w-[200px] bg-slate-800 rounded-t-[3rem] h-20 mb-8 border-b-4 border-slate-700 flex items-end justify-center pb-2"><span className="text-slate-500 text-xs font-bold uppercase tracking-widest">Avant du bus</span></div>
        ...
        {step === 4 && (
          <div className="max-w-xl mx-auto space-y-6 text-center animate-in slide-in-from-right-8 duration-300">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <button className="bg-slate-900 border border-slate-700 hover:border-emerald-500 hover:bg-emerald-500/10 rounded-2xl p-6 flex flex-col items-center justify-center gap-3 transition-all group">
                <CreditCard className="w-8 h-8 text-slate-400 group-hover:text-emerald-400" />
                <span className="font-bold text-white">Espèces</span>
              </button>
              <button className="bg-slate-900 border border-slate-700 hover:border-blue-500 hover:bg-blue-500/10 rounded-2xl p-6 flex flex-col items-center justify-center gap-3 transition-all group">
