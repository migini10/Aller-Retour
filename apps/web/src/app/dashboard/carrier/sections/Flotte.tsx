  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {flotte.map(v => (
          <div key={v.id} className="bg-[#141414] border border-[#2A2A2A]/80 hover:border-orange-500/30 rounded-2xl p-5 transition-colors flex flex-col justify-between h-full group">
            <div>
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex flex-col items-end gap-1">
                  ...
                  <span className="font-mono text-xs font-bold text-slate-300 bg-[#222222] px-2 py-0.5 rounded border border-[#333333]">{v.id}</span>
                </div>
              </div>
            ...
            <div className="mt-5 pt-4 border-t border-[#2A2A2A]/80 space-y-3">
            ...
            <button className="mt-5 w-full bg-[#1A1A1A] border border-[#333333] hover:bg-[#222222] text-white font-semibold py-2 rounded-xl text-xs transition-colors flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 focus:opacity-100">
