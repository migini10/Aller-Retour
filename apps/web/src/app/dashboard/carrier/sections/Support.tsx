    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="bg-[#141414] border border-[#2A2A2A] rounded-3xl p-6">
          ...
          <button className="bg-[#1A1A1A] hover:bg-[#222222] text-white font-bold px-4 py-2.5 rounded-xl text-sm w-full transition-colors border border-[#333333]">Appeler le Support</button>
        </div>
      </div>
