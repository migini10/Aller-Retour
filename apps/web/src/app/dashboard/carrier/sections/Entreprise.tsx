  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#141414] border border-[#2A2A2A]/80 rounded-2xl p-6 lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button className="text-xs bg-[#222222] hover:bg-slate-700 text-white px-3 py-1.5 rounded-lg border border-[#333333] transition-colors">Modifier</button>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label className="text-xs text-slate-500 font-semibold mb-1 block">Raison Sociale</label>
              <input type="text" value="Sénégal Express GIE" readOnly className="w-full bg-[#1A1A1A] border border-[#333333] rounded-xl px-4 py-2.5 text-sm text-slate-200 outline-none" />
            </div>
            <div>
              <label className="text-xs text-slate-500 font-semibold mb-1 block">Numéro NINEA</label>
              <input type="text" value="001234567 2V2" readOnly className="w-full bg-[#1A1A1A] border border-[#333333] rounded-xl px-4 py-2.5 text-sm text-slate-200 outline-none font-mono" />
            </div>
            <div>
              <label className="text-xs text-slate-500 font-semibold mb-1 block">Registre du Commerce (RCCM)</label>
              <input type="text" value="SN-DKR-2019-B-12345" readOnly className="w-full bg-[#1A1A1A] border border-[#333333] rounded-xl px-4 py-2.5 text-sm text-slate-200 outline-none font-mono" />
            </div>
            <div>
              <label className="text-xs text-slate-500 font-semibold mb-1 block">Type de structure</label>
              <input type="text" value="Groupement d'Intérêt Économique (GIE)" readOnly className="w-full bg-[#1A1A1A] border border-[#333333] rounded-xl px-4 py-2.5 text-sm text-slate-200 outline-none" />
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-[#2A2A2A]">
            ...
            <div className="grid grid-cols-1 gap-5">
              <div>
                ...
                <input type="text" value="Gare Routière des Baux Maraîchers, Pikine, Dakar" readOnly className="w-full bg-[#1A1A1A] border border-[#333333] rounded-xl px-4 py-2.5 text-sm text-slate-200 outline-none" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#141414] border border-[#2A2A2A]/80 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className={`p-3 rounded-xl border ${doc.date === 'En attente' ? 'bg-amber-500/10 border-amber-500/20' : 'bg-[#1A1A1A]/50 border-[#2A2A2A]'} flex items-center justify-between`}>
