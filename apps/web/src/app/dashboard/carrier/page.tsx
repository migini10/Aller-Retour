...
import { 
  ...
  Wallet, Store, BarChart3, Bell, HelpCircle, Settings, ChevronRight
} from 'lucide-react';
...
export default function CarrierDashboard() {
  ...
  return (
    <div className="flex flex-col min-h-full w-full overflow-y-auto scrollbar-hide">
      ...
      <div className="flex-1 flex flex-col xl:flex-row gap-4 xl:gap-8 max-w-[1400px] mx-auto w-full px-5 sm:px-8 xl:px-12 py-4 xl:py-6 overflow-visible">
