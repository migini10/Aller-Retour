    ...
    <div className="space-y-6 max-w-[1400px] mx-auto pb-10">
      ...
      <div className="flex flex-col xl:flex-row gap-8">
        ...
        <div className="xl:w-64 shrink-0">
          <div className="flex xl:flex-col overflow-x-auto xl:overflow-y-auto pb-2 xl:pb-2 gap-1.5 xl:gap-2 scrollbar-hide xl:sticky xl:top-32 xl:max-h-[calc(100vh-160px)] xl:bg-[#101728] xl:border xl:border-slate-800/80 xl:p-4 xl:rounded-3xl">
            {navItems.map((item) => {
