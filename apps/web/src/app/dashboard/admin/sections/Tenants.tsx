  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-white flex items-center gap-2"><Building2 className="w-5 h-5 text-orange-400" /> Gestion Multi-Tenant (B2B)</h2>
            ...
            <tbody className="divide-y divide-slate-800/60 text-sm">
              {tenants.map(t => (
                <tr key={t.id} className="hover:bg-[#222222]/30 transition-colors">
                  ...
                  <td className="py-4">
                    <span className="bg-orange-500/10 text-orange-400 px-2 py-1 rounded-md text-xs font-bold border border-orange-500/20">{t.plan}</span>
                  </td>
