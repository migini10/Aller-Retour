  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-lg font-bold text-white flex items-center gap-2"><Activity className="w-5 h-5 text-orange-400" /> Monitoring & Santé Système</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#141414] border border-[#2A2A2A] rounded-2xl p-5">
          ...
          <div className="w-full h-1.5 bg-[#222222] rounded-full"><div className="w-1/3 h-full bg-orange-500 rounded-full"></div></div>
        ...
        <div className="bg-[#141414] border border-[#2A2A2A] rounded-2xl p-5">
          ...
          <div className="w-full h-1.5 bg-[#222222] rounded-full"><div className="w-[5%] h-full bg-amber-500 rounded-full"></div></div>
      ...
      <div className="bg-[#141414] border border-[#2A2A2A]/80 rounded-2xl p-5">
        ...
        <div className="bg-black rounded-xl p-4 font-mono text-[10px] text-slate-400 space-y-2 h-64 overflow-y-auto border border-[#2A2A2A]">
          <p><span className="text-emerald-400">[20:45:12] INFO</span>: (WebSocket) Client connecté [USR-8821]</p>
          <p><span className="text-orange-400">[20:45:10] REQ </span>: POST /api/v1/payments/webhook - 200 OK (24ms)</p>
          <p><span className="text-orange-400">[20:45:08] REQ </span>: GET /api/v1/fleet/location - 200 OK (15ms)</p>
          ...
          <p><span className="text-orange-400">[20:44:50] REQ </span>: POST /api/v1/auth/login - 200 OK (80ms)</p>
        </div>
      </div>
    </div>
  );
