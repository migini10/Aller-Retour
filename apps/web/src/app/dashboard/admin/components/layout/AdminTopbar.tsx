    ...
    <div className="flex-none z-40 bg-white/95 dark:bg-[#0A0A0A]/95 backdrop-blur-xl border-b border-slate-200 dark:border-[#2A2A2A]/80 px-4 sm:px-6 lg:px-8 py-3 sticky top-0">
      <div className="flex items-center justify-between gap-4 w-full">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold text-slate-900 dark:text-white leading-none">Abdou Bakhe</h1>
            <p className="text-[10px] text-orange-600 dark:text-orange-400 font-bold uppercase tracking-wider mt-1">Super Admin</p>
          </div>
        </div>
