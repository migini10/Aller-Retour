      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-[#101728] border border-slate-800/80 rounded-2xl p-5 lg:col-span-2">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4">
            <div>
              <p className="text-2xl font-bold text-white">Dakar → Touba</p>
              <p className="text-sm text-slate-400 mt-1">Départ à 14:30 • Bus 50 places</p>
        ...
        <div className="bg-[#101728] border border-slate-800/80 rounded-2xl p-5">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xl font-bold text-white">45 000 FCFA</p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-white">120 km</p>
              </div>
            </div>
          </div>
        </div>
