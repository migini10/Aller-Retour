      ...
      <div className="space-y-4">
        ...
        <div className="bg-[#101728] border border-slate-800 rounded-2xl p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" value="+221 77 000 00 00" readOnly className="w-full bg-slate-900 border border-slate-800 rounded-xl px-3 py-2 text-sm text-slate-300 outline-none" />
            </div>
            <div>
              <label className="text-xs text-slate-500 font-semibold mb-1 block">Email</label>
              <input type="text" value="moussa@example.com" readOnly className="w-full bg-slate-900 border border-slate-800 rounded-xl px-3 py-2 text-sm text-slate-300 outline-none" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#101728] border border-slate-800 rounded-2xl p-5">
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-slate-800/50 transition-colors border border-transparent hover:border-slate-800">
