    ...
    <aside className="w-full h-full bg-[#0B0F19]/95 backdrop-blur-xl border-r border-slate-800/80 flex flex-col p-4 shadow-sm overflow-hidden">
      <div className="flex-none">
        ...
        <Link
          href="/"
          onClick={onLinkClick}
          className="hidden lg:flex items-center gap-3 mb-8 group/logo"
        >
          ...
          <div className="lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap flex-1 overflow-hidden">
        ...
        <div className="mb-8 overflow-hidden">
          <Link
            href="/"
            onClick={onLinkClick}
            className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-900 border border-slate-800 hover:border-orange-500/50 text-xs font-semibold text-slate-300 hover:text-white transition-all group/btn shadow-sm"
          >
            <ArrowLeft className="w-4 h-4 text-orange-500 shrink-0 group-hover/btn:-translate-x-1 transition-transform" />
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden overscroll-contain scrollbar-hide -mx-2 px-2 space-y-1.5">
        <p className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-4 px-2 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
          Espaces & Rôles
        </p>
        {navItems.map((item) => {
      ...
      {/* Logout Footer */}
      <div className="flex-none pt-6 border-t border-slate-800/80 mt-auto overflow-hidden">
        <button className="flex items-center gap-3 p-3 w-full rounded-xl text-slate-400 hover:bg-rose-500/10 hover:text-rose-400 transition-colors">
