...
var ReviewsController = function () {
    var _classDecorators = [(0, common_1.Controller)('reviews'), (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), rbac_guard_1.RbacGuard), (0, roles_decorator_1.Roles)(database_1.UserRole.SUPER_ADMIN)];
    ...
    var ReviewsController = _classThis = /** @class */ (function () {
        ...
        ReviewsController_1.prototype.findAll = function (query) {
            return this.reviewsService.findAll(query);
        };
        ReviewsController_1.prototype.findOne = function (id) {
            return this.reviewsService.findOne(id);
        };
        ReviewsController_1.prototype.updateStatus = function (id, updateReviewStatusDto) {
