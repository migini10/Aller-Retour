...
var NotificationsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Notifications'), (0, common_1.Controller)('notifications'), (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), rbac_guard_1.RbacGuard), (0, swagger_1.ApiBearerAuth)()];
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.getNotifications = function (filters) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.notificationsService.getNotifications(filters)];
                });
            });
        };
    ...
    (function () {
        ...
        _getNotifications_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)(database_1.UserRole.SUPER_ADMIN), (0, swagger_1.ApiOperation)({ summary: 'Get all notifications (Super Admin)' }), (0, swagger_1.ApiResponse)({
                status: 200,
