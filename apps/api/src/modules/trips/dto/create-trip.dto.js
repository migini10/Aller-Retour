...
var CreateTripDto = function () {
    ...
    var _assignedDriverId_decorators;
    var _assignedDriverId_initializers = [];
    var _assignedDriverId_extraInitializers = [];
    ...
    return _a = /** @class */ (function () {
            function CreateTripDto() {
                ...
                this.assignedDriverId = (__runInitializers(this, _vehicleId_extraInitializers), __runInitializers(this, _assignedDriverId_initializers, void 0));
                this.pricePerSeat = (__runInitializers(this, _assignedDriverId_extraInitializers), __runInitializers(this, _pricePerSeat_initializers, 5000));
                this.placesLibres = (__runInitializers(this, _pricePerSeat_extraInitializers), __runInitializers(this, _placesLibres_initializers, 4));
                this.passagers = (__runInitializers(this, _placesLibres_extraInitializers), __runInitializers(this, _passagers_initializers, 0));
                this.vehicleCapacity = (__runInitializers(this, _passagers_extraInitializers), __runInitializers(this, _vehicleCapacity_initializers, 5));
        ...
        (function () {
            ...
            _originCity_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)()];
            _destinationCity_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)()];
            _departureTime_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsDateString)()];
            _vehicleId_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsString)()];
            _assignedDriverId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            ...
            __esDecorate(null, null, _assignedDriverId_decorators, { kind: "field", name: "assignedDriverId", static: false, private: false, access: { has: function (obj) { return "assignedDriverId" in obj; }, get: function (obj) { return obj.assignedDriverId; }, set: function (obj, value) { obj.assignedDriverId = value; } }, metadata: _metadata }, _assignedDriverId_initializers, _assignedDriverId_extraInitializers);
