...
var SettingsService = function () {
    ...
    var SettingsService = _classThis = /** @class */ (function () {
        function SettingsService_1() {
            this.logger = new common_1.Logger(SettingsService.name);
            // Cache en mémoire
            this.cachedSettings = null;
            this.cacheExpiresAt = 0;
            this.CACHE_TTL_MS = 60000; // 60 secondes
        }
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (this.cachedSettings && now < this.cacheExpiresAt) {
                                return [2 /*return*/, this.cachedSettings];
                            }
                            return [4 /*yield*/, database_1.prisma.systemSetting.upsert({
                                    where: { id: 'default' },
                                    update: {},
                                    create: {}
                                })];
        ...
        SettingsService_1.prototype.updateSettings = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var settings;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, database_1.prisma.systemSetting.upsert({
                                where: { id: 'default' },
                                update: dto,
                                create: __assign({}, dto)
                            })];
